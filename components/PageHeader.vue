<template>
  <div class="fixed top-0 left-0 w-full z-[100]">
    ...
    <header class="relative z-50 bg-white/95 backdrop-blur-xl border-b border-gray-100 transition-all duration-500">
      <div class="max-w-7xl mx-auto flex justify-between items-center px-6 md:px-10 py-4">
        ...
        <nav class="hidden lg:flex items-center space-x-10">
          ...
          >
            ...
            <transition name="dropdown-slide">
              <div
                v-if="showDropdown"
                class="absolute top-full right-0 mt-1 w-56 bg-white rounded-3xl shadow-3xl border border-gray-100 py-4 overflow-hidden z-[60]"
              >
                <NuxtLink
        ...
        <button @click="mobileMenuOpen = !mobileMenuOpen" class="lg:hidden p-3 bg-gray-50 rounded-2xl text-gray-900 focus:outline-none">
    ...
    <div class="relative z-40 bg-gray-50/80 backdrop-blur-md border-b border-gray-100 py-2 px-6">
    ...
    <transition name="mobile-fade">
      <div v-if="mobileMenuOpen" class="lg:hidden absolute inset-x-0 top-full bg-white border-t-4 border-red-600 shadow-2xl h-[calc(100vh-80px)] overflow-y-auto p-8 z-[100]">
...
// Toggle Funktion für Klick
const toggleDropdown = () => {
  showDropdown.value = !showDropdown.value
}

// Click-Outside Logik: Schließt Dropdown wenn man woanders hinklickt
if (process.client) {
